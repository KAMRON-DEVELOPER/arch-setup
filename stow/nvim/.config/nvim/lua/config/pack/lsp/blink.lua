...
vim.api.nvim_create_autocmd("PackChanged", {
  ...
  callback = function(ev)
    ...
    if not ok then
      vim.notify("blink.cmp installed. Restart Neovim, then run :BlinkBuild if needed", vim.log.levels.WARN)
      return
    end
...
if settings.blink.friendly_snippets then
  table.insert(plugins, { src = "https://github.com/rafamadriz/friendly-snippets" })
end
